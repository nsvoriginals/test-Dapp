  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          "flex h-12 w-full rounded-xl border-2 border-transparent bg-gradient-to-br from-background via-muted to-card px-4 py-2 text-base shadow-lg transition-all duration-300 outline-none",
